 ...
 * Aggregationsintervalle richtig bestimmt werden (dies muss stichprobenartig anhand der
...
public class AggregationsIntervallTest {
	 ...
	 * - ob die Berechnungszeitpunkte fuer die unterschiedlichen Aggregationsintervalle richtig
	 * bestimmt werden (dies muss stichprobenartig anhand der Konsolenausgabe nachgeprueft werden).
	 *
	 * @throws Exception
	 *             wird weitergereicht
	 */
