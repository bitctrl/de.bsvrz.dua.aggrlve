...
public class AggregationUnvImporter extends CSVImporter {
	 ...
	 *         Ende ist
	 */
	public final Data getAnalyseDatensatz(boolean mq, long intervallLaenge,
			int fsIndex) {
			...
			if (ZEILE != null) {
				try {
					...
					datensatz = setAttribut(
							(mq ? "Q" : "q") + "Kfz", QKfz, QKfzStatus, datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
					datensatz = setAttribut(
							(mq ? "Q" : "q") + "Lkw", QLkw, QLkwStatus, datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
					datensatz = setAttribut(
							(mq ? "Q" : "q") + "Pkw", QPkw, QPkwStatus, datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
					datensatz = setAttribut(
							(mq ? "V" : "v") + "Kfz", VKfz, VKfzStatus, datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
					datensatz = setAttribut(
							(mq ? "V" : "v") + "Lkw", VLkw, VLkwStatus, datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
					datensatz = setAttribut(
							(mq ? "V" : "v") + "Pkw", VPkw, VPkwStatus, datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
					datensatz = setAttribut(
							(mq ? "V" : "v") + "gKfz", -1, "0", datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
					datensatz = setAttribut(
							(mq ? "B" : "b"), -1, "0", datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
					if (mq) {
						datensatz = setAttribut(
								(mq ? "B" : "b") + "Max", -1, "0", datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
						datensatz = setAttribut(
								(mq ? "V" : "v") + "Delta", -1, "0", datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
					}
					datensatz = setAttribut(
							(mq ? "S" : "s") + "Kfz", -1, "0", datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
					datensatz = setAttribut(
							(mq ? "A" : "a") + "Lkw", -1, "0", datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
					datensatz = setAttribut(
							(mq ? "K" : "k") + "Kfz", -1, "0", datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
					datensatz = setAttribut(
							(mq ? "K" : "k") + "Lkw", -1, "0", datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
					datensatz = setAttribut(
							(mq ? "K" : "k") + "Pkw", -1, "0", datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
					datensatz = setAttribut(
							(mq ? "Q" : "q") + "B", -1, "0", datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
					datensatz = setAttribut(
							(mq ? "K" : "k") + "B", -1, "0", datensatz); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$			
